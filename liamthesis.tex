...
%\title{Probing the Long-Wavelength Sky at High Time Resolution}
\title{CHIME and Probing the Origin of Fast Radio Bursts}
%\title{CHIME and Long-Wavelength Time-Variable Astrophysics}
%\title{Fast Radio Bursts, Pulsars, and the Canadian Hydrogen Intensity Mapping Experiment}
% ----------------------------------------------------------------------------------------------------------------------------------------
...
$\frac{\partial \log N}{\partial \log S}$, where 
$N$ and $S$ are the cumulative number count and 
...
also showed that the rate of FRBs at low frequencies is consistent
...
in full-polarization and present results on its quasi-periodic 
structure. 
\end{abstract}
