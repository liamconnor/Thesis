...
as well as undiscovered phenomena. 
...
We find consistency with a Euclidean distribution, meaning 
current observations cannot distinguish between 
...
We outline this instrument and describe the creation 
of a digital beamforming back-end on its Pathfinder. 
We also discuss the commissioning of a real-time VLBI 
FRB search between it and the Algonquin Radio Observatory (ARO)
46\,m telescope. This includes results from the first couple of
months of Pathfinder data. Finally, we present a study of 
