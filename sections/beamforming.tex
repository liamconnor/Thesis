...
1-100 ms, and looks for peaks above 8.5$\sigma$. If it finds something
...
by inspecting each trigger visually. 

Using a signal-to-noise cutoff of $s_m$, the fraction 
of events one expects above $s$ is given by,

\begin{equation}
f(>s) = \left(\frac{s}{s_m}\right)^\alpha
\end{equation}
