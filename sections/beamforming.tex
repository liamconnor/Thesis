...
distribution, $N(S)$. We exclude $\alpha < 0.6$ with 95\% confidence, 
which provides a new lower-bound on that parameter. 
% ================================================================================
% INTRODUCTION
% ================================================================================
...
\caption[abc]{Block diagram of the beamforming back-end on CHIME Pathfinder. 
     ...
     comprised of 16 GPU nodes. Each node received 64 frequency channels,
